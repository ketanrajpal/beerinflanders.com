...
class cls_ps_forms extends cls_ps_base
{
	...
	var $fs_name = 'forms';
	var $fs_edit_inp = array( '(fd)', '(edit_inp)' );
	var $fs_edit_save = array( '(fd)', '(edit_save)' );
	var $fs_reg_inp = array( '(fd)', '(reg_inp)' );
	var $fs_reg_save = array( '(fd)', '(reg_save)' );
	var $fs_del_inp = array( '(fd)', '(del_inp)' );
