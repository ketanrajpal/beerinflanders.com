...
class CHtmlMacro extends CObject
{
	...
	{
	?>
	<fieldset style='margin:10px 0;text-align:left;'>
	<?php if ( $label != null ) { ?>
		<legend class="legendTitle"><?php echo $label; ?></legend>
	<?php } ?>
	<?php
	}
	...
	function Button( $args )
	{
		...
		if ( $tag_name == '' ) $tag_name = $this->GetDefaultButtonType();
		return call_user_func_array( array( $this, 'Button_' . $tag_name ),
			array( $args, $tag_name, $tag_begin, $tag_end ) );
	}
